...
try:
    ...
    Font1 = ImageFont.truetype("/home/pi/Documents/oled/Font/Font00.ttf", 25)
    Font2 = ImageFont.truetype("/home/pi/Documents/oled/Font/Font00.ttf", 35)
    Font3 = ImageFont.truetype("/home/pi/Documents/oled/Font/Font00.ttf", 32)
    ...
    logging.info("paste image at specific position")
    splash = Image.open("/home/pi/Documents/oled/image/usb_on.png")
    image1.paste(splash, (50, 100))  # Paste image at x=50, y=100
    ...
    draw.text((60, 2), "题龙阳县青草湖", fill=808000, font=Font3)
    draw.text((100, 42), "元  唐珙", fill=808080, font=Font3)
    draw.text((60, 82), "西风吹老洞庭波，", fill="BLUE", font=Font3)
    draw.text((60, 122), "一夜湘君白发多。", fill="RED", font=Font3)
    draw.text((60, 162), "醉后不知天在水，", fill="GREEN", font=Font3)
    draw.text((60, 202), "满船清梦压星河。", fill="BLACK", font=Font3)
    image2 = image2.rotate(0)
    disp.ShowImage(image2)
    time.sleep(2)

    logging.info("show image")
    ImagePath = ["/home/pi/Documents/oled_splashscreen.png"]
